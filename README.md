...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/astrometry-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/astrometry-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install astrometry
```
...
It is possible to list all of the versions of `astrometry` available on your platform:
...
```
pixi search astrometry --channel conda-forge
```
